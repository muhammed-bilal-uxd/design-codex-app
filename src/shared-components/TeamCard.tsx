...
const MohammedMansoor = "/assets/mohammed-mansoor-transparent-1.png";
const Mukilan = "/assets/mukilan-transparent.png";
const Archana = "/assets/archana-transparent.png";
const Shalini = "/assets/shalini-transparent.png";
const MuhammedBilal = "/assets/muhammed-bilal-transparent-4.png";
const SuhailAhmed = "/assets/suhail-ahmed-transparent-bg.png";
const GrainImg = "/assets/grain.webp";
const IconPatternImg = "/assets/iconpattern.png";
      ...
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="mt-8 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {mentorsDetails.map(
              ({ id, name, role, subRole, experience, avatarUrl }) => (
                <ProfileCard
                  key={id}
                  name={name}
                  title={role}
